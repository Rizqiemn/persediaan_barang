    ...
    <div class="col-md-8">
        <div class="card shadow-sm border-bottom-primary">
            ...
            <div class="card-body">
                ...
                <div class="row form-group">
                    <label class="col-md-3 text-md-right" for="ket_barang">Keterangan Barang</label>
                    <div class="col-md-9">
                        <input value="<?= set_value('ket_barang'); ?>" name="ket_barang" id="ket_barang" type="text" class="form-control" placeholder="Keterangan Barang...">
                        <?= form_error('ket_barang', '<small class="text-danger">', '</small>'); ?>
                    </div>
                </div>
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            <select name="jenis_id" id="jenis_id" class="custom-select cari_jenis">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            <select name="satuan_id" id="satuan_id" class="custom-select cari_satuan">
