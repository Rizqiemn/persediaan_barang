        ...
        <div class="card shadow-sm border-bottom-primary">
            ...
            <div class="card-body">
                ...
                <div class="row form-group">
                    <label for="barang_masuk">ID Transaksi Barang Masuk</label>
                    <div class="col-md-4">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-5">
                        <div class="input-group">
                            <select name="supplier_id" id="supplier_id" class="custom-select cari_supply">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-5">
                        <div class="input-group">
                            <select name="barang_id" id="barang_id" class="custom-select cari_barang">
                                <option value="" selected disabled>Pilih Barang</option>
                                <?php foreach ($barang as $b) : ?>
                                    <option <?= $this->uri->segment(3) == $b['id_barang'] ? 'selected' : '';  ?> <?= set_select('barang_id', $b['id_barang']) ?> value="<?= $b['id_barang'] ?>"><?= $b['id_barang'] . ' | ' . $b['nama_barang'] . " " . $b['ket_barang'] ?></option>
                                <?php endforeach; ?>
                            </select>
                            <div class="input-group-append">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-5">
                        <input value="<?= set_value('harga_beli'); ?>" name="harga_beli" id="harga_beli" type="number" class="form-control" placeholder="Jumlah Masuk...">

                    </div>
                </div>
                <div class="row form-group">
                    <label class="col-md-4 text-md-right" for="total_beli">Total Harga Beli</label>
                    <div class="col-md-5"><input value="<?= set_value('total_beli'); ?>" name="total_beli" id="total_beli" type="number" class="form-control" placeholder="Jumlah Masuk...">*jangan diisi
                    </div>

                    <?= form_error('total_beli', '<small class="text-danger">', '</small>'); ?>
                </div>
                <div class="row form-group">
