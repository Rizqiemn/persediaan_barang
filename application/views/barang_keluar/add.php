        ...
        <div class="card shadow-sm border-bottom-primary">
            ...
            <div class="card-body">
                        ...
                        <div class="input-group">
                            ...
                            <select name="barang_id" id="barang_id" class="custom-select cari_barang">
                                ...
                                <?php foreach ($barang as $b) : ?>
                                    <option value="<?= $b['id_barang'] ?>"><?= $b['id_barang'] . ' | ' . $b['nama_barang'] . ' ' . $b['ket_barang'] ?></option>
                                <?php endforeach; ?>
                            </select>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-5">
                        <input readonly="readonly" id="harga_beli" type="number" class="form-control">
                    </div>
                </div>
                <div class="row form-group">
                    <label class="col-md-4 text-md-right" for="harga_jual">Harga Jual</label>
                    <div class="col-md-5">
                        <input value="<?= set_value('harga_jual'); ?>" name="harga_jual" id="harga_jual" type="number" class="form-control" placeholder="Harga Jual...">
                    </div>
                    <?= form_error('jumlah_keluar', '<small class="text-danger">', '</small>'); ?>
                </div>
                <div class="row form-group">
                    <label class="col-md-4 text-md-right" for="total_jual">Total Harga Jual</label>
                    <div class="col-md-5">
                        <input value="<?= set_value('total_jual'); ?>" name="total_jual" id="total_jual" type="number" class="form-control" placeholder="Total Harga Jual...">*jangan diubah
                    </div>
                </div>
                <div class="row form-group">
