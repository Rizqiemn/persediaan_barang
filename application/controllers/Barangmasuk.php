...
class Barangmasuk extends CI_Controller
{
    ...
    private function _validasi()
    {
        ...
        $this->form_validation->set_rules('harga_beli', 'Barang', 'required|trim|numeric|greater_than[0]');
        $this->form_validation->set_rules('total_beli', 'Barang', 'required|trim|numeric|greater_than[0]');
